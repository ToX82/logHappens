...
<div class="fixed-action-btn">
    ...
    <ul>
        <li>
            <a class="btn-floating green darken-2 viewLink" href="file:///<?= $item['file'] ?>" target="_blank">
                <i class="material-icons tooltipped" data-position="left" data-delay="50" data-tooltip="Open this log file">visibility</i>
            </a>
        </li>
        <li>
            <a class="btn-floating red truncateLink" href="ajax.php?action=truncate&amp;logFile=<?= $item['file'] ?>">
